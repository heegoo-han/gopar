...
(use-package org-roam
  ...
  (org-roam-dailies-capture-templates
   `(("d" "daily" plain (file "~/gopar/org/templates/dailies-daily.template")
      :target (file+head "daily/%<%Y-%m-%d>.org" "#+title: %<%Y-%m-%d>\n"))

     ("w" "weekly" plain (file "~/gopar/org/templates/dailies-weekly.template")
      :target (file+head "weekly/%<%Y-%m-%d>.org" "#+title: %<%Y-%m-%d>\n"))

     ("m" "monthly" plain (file "~/gopar/org/templates/dailies-monthly.template")
...
(progn
  ...
  (set-face-attribute 'default t :font "JetBrainsMonoNL Nerd Font 15"))
#+end_src
