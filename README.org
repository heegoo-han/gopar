...
* Prerequisites
sudo apt install ledger silversearcher-ag python3-venv
cd ~/gopar/
touch org/agenda-files.org
mkdir -p org/private/org-roam/gtd
touch org/private/org-roam/gtd/archives.org

theme...
M-x load-theme
  doom-nord-aurora
I don't know how to add the above in README.org,
so do Ctrl-z -> doom-nord-aurora  when beginning of the gopar run
...
next potential sentence end"
  ...
  (defun gopar/add-env-vars ()
    ...
    (load-file "~/gopar/etc/eshell/set_env.el")
...
(use-package org
  ...
  (org-directory "~/gopar/org/")
  ;; Where archives should go
  (org-archive-location (concat (expand-file-name "~/gopar/org/private/org-roam/gtd/archives.org") "::"))
  ...
  (org-refile-targets '(("~/gopar/org/private/org-roam/gtd/gtd.org" :maxlevel . 3)
                        ("~/gopar/org/private/org-roam/gtd/someday.org" :level . 1)
                        ("~/gopar/org/private/org-roam/gtd/tickler.org" :maxlevel . 1)
                        ("~/gopar/org/private/org-roam/gtd/repeat.org" :maxlevel . 1)
                        ))
...
(use-package org-agenda
  ...
  (org-agenda-files "~/gopar/org/agenda-files.org")
   ...
   '(("h" "Agenda and Home tasks"
     ...
     ("r" "Weekly Review"
      ...
      ((org-agenda-sorting-strategy '(time-up habit-up category-up priority-down ))
       (org-agenda-files "~/gopar/org/weekly-reivew-agenda-files.org")
...
(use-package org-capture
  ...
  (org-capture-templates
   '(
     ("c" "Inbox" entry (file "~/gopar/org/private/org-roam/gtd/inbox.org")
      "* TODO %?\n:PROPERTIES:\n:DATE_ADDED: %u\n:END:")
     ("p" "Project" entry (file "~/gopar/org/private/org-roam/gtd/gtd.org")
      "* %? [%] :project: \n:PROPERTIES: \n:TRIGGER: next-sibling todo!(NEXT) scheduled!(copy)\n:ORDERED: t \n:DATE_ADDED: %u\n:END:\n** TODO Add entry")
     ("t" "Tickler" entry (file "~/gopar/org/private/org-roam/gtd/tickler.org")
      "* TODO %? \nSCHEDULED: %^{Schedule}t\n:PROPERTIES:\n:DATE_ADDED: %u\n:END:\n")
     ("k" "Contact" entry (file "~/gopar/org/private/org-roam/references/contacts.org")
      "* %? \n%U
:PROPERTIES:
:EMAIL:
:PHONE:
...
(use-package org-roam
  ...
  :custom
  (org-roam-v2-ack t)
  (org-roam-directory (expand-file-name "~/gopar/org/private/org-roam"))
  (org-roam-db-location (expand-file-name "~/gopar/org/private/org-roam.db"))
  ...
  (org-roam-capture-templates
   '(("d" "default" plain "%?"
      ...
      :unnarrowed t)))
  (org-roam-dailies-directory (expand-file-name "~/gopar/org/private/journal/"))
  (org-roam-dailies-capture-templates
   `(("d" "daily" plain (file "/Users/gopar/gopar/org/templates/dailies-daily.template")
      :target (file+head "daily/%<%Y-%m-%d>.org" "#+title: %<%Y-%m-%d>\n"))

     ("w" "weekly" plain (file "/Users/gopar/gopar/org/templates/dailies-weekly.template")
      :target (file+head "weekly/%<%Y-%m-%d>.org" "#+title: %<%Y-%m-%d>\n"))

     ("m" "monthly" plain (file "/Users/gopar/gopar/org/templates/dailies-monthly.template")
...
(use-package files
  :ensure nil
  :custom
  (insert-directory-program "ls") ; Will not work if system does not have GNU gls installed
  ;; Don't have backup
  (backup-inhibited t)
  ;; Don't save anything.
...
(set-fontset-font t 'hangul (font-spec :name "Noto Sans CJK HK"))
#+end_src

* End
#+begin_src emacs-lisp
(progn
  (add-to-list 'default-frame-alist `(font . "JetBrainsMonoNL Nerd Font 15"))
  (set-face-attribute 'default nil :font "JetBrainsMonoNL Nerd Font 15"))
#+end_src
